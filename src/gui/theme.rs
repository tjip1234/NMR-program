...
pub struct ThemeColors {
    ...
    pub integration_colors: [egui::Color32; 5],
...
impl ThemeColors {
    ...
    fn light() -> Self {
        Self {
            ...
            integration_colors: [
                egui::Color32::from_rgb(0x3B, 0x59, 0x98), // Slate blue
                egui::Color32::from_rgb(0x55, 0x6B, 0x2F), // Olive green
                egui::Color32::from_rgb(0xA0, 0x52, 0x2D), // Sienna
                egui::Color32::from_rgb(0x00, 0x80, 0x80), // Teal
                egui::Color32::from_rgb(0x6A, 0x5A, 0xCD), // Slate purple
            ],
    ...
    fn cyberpunk() -> Self {
        Self {
            ...
            integration_colors: [
                egui::Color32::from_rgb(0x00, 0xFF, 0xE0), // cyan
                egui::Color32::from_rgb(0xFF, 0x00, 0x8C), // pink
                egui::Color32::from_rgb(0xBD, 0x00, 0xFF), // purple
                egui::Color32::from_rgb(0xFF, 0xD6, 0x00), // yellow
                egui::Color32::from_rgb(0xFF, 0x8C, 0x00), // orange
            ],
